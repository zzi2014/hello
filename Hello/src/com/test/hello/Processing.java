...
public class Processing {
	...
	public static Boolean compareCIElab(Mat img,Point center,Point[] plocate,Point[] nlocate){
		return true;
	}
	...
	public static Boolean compareHSV(Mat img,Point center,Point[] plocate,Point[] nlocate){
		...
		comB=3*Math.pow((average[0][2]-average[2][2]),2)+4*Math.pow((average[0][1]-average[2][1]),2)+2*Math.pow((average[0][0]-average[2][0]),2);
		if (comA>comB)
        	flag--;
        else
        	flag++;
